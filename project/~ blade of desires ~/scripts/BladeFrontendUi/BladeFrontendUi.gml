...
#macro BLADE_FRONTEND_UI_FRAME_COUNT 1
#macro BLADE_FRONTEND_UI_FRAME_WIDTH 128
#macro BLADE_FRONTEND_UI_FRAME_HEIGHT 128
#macro BLADE_FRONTEND_UI_GUIDE_LEFT 32
#macro BLADE_FRONTEND_UI_GUIDE_RIGHT 32
#macro BLADE_FRONTEND_UI_GUIDE_TOP 32
#macro BLADE_FRONTEND_UI_GUIDE_BOTTOM 32
...
/// Creates a runtime sprite and configures its native nine-slice guides.
...
/// Draws one reusable panel with native nine-slice rendering and state tinting.
function BladeFrontendUiDrawPanel(
    ...
    if (is_struct(_ui)
        ...
        && _ui.ready
        && sprite_exists(_ui.sprite)) {
        var _blend = _selected
            ? c_white
            : make_color_rgb(112, 143, 140);
        var _draw_alpha = _alpha * (_selected ? 1 : 0.56);
        // Native nine-slice is applied by this whole-sprite draw.
